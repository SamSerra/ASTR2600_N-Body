...
def calculateForceVectors(masses, positions):
    ...
    # use our plotting function to plot circles for the particles themselves
    ...
    for i in range(N):
        ...
        # plot one arrow, starting at positions[i], with direction of vector
        plt.quiver(positions[i][0]/au, positions[i][1]/au, vector[0], vector[1])
