...
newtonian gravity. The initial velocities are halved from EarthInCircularOrbit.py

The input data is:

Particle | mass (kg) | x (au) | y (au) | z (au) | Vx (m/s) | Vy (m/s)   | Vz
------------------------------------------------------------------------
Sun      | 1.989e30  | -3e-6  | 0.0    | 0.0    | 0.0      | -8.94e-2/2 | 0.0
Earth    | 5.972e24  | .999997| 0.0    | 0.0    | 0.0      | 2.98e4/2   | 0.0
...
initVel /= 2.0 #halve the initial velocities
